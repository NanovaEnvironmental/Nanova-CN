...
export const AUTO_MAT_EMMISION = {
    ...
    description: [
        {
            title: '保证质量和合规性',
            para: [
                '车辆内的 VOC 浓度可达到明显高于室内环境推荐浓度的水平。汽车内饰中使用的材料、粘合剂和饰面会在新车或受热时释放出这些化学物质。接触会加剧过敏和哮喘症状，并对眼睛、鼻子、皮肤和喉咙造成刺激。一些 VOC 也被认为会导致癌症和其他神经系统问题。因此，验证汽车内部材料的质量以确保安全和健康非常重要。',
    ...
    challenges: {
        para: [
            '传统的测试技术速度慢，可能会延迟生产，需要以高灵敏度进行更快的采样和分析，以提供有效响应所需的即时反馈',
    ...
    description: [
        {
            title: '快速识别泄漏和缺陷',
            para: [
                '汽车可以从各种部件和泄漏处释放挥发性有机化合物 (VOC)。这些挥发性有机化合物可能对人体健康和环境有害。因此，此类 VOC 受法规约束，不得超过某些阈值。然而，当超过阈值时，确定泄漏或组件缺陷的来源可能很困难。因此，需要能够提供快速和全面分析并产生易于理解和有用的结果的可访问技术。',
                'NovaTest P100 和 P300 可以在任何位置快速采样和分析环境空气，使其成为排放测试和泄漏检测的有用设备。该设备从环境空气中取样，无需任何额外的设备或样品制备。紧凑的设计使他们能够方便地测试传统台式设备无法进入的较小空间中的空气。它们能够在一次测试中以高灵敏度检测各种化合物，并且系统会自动生成带有计算结果的即时报告。这些功能可以轻松地用于生产线、停车场或检查车间，以快速识别车辆中的泄漏和其他排放源。',
    ...
    description: [
        {
            title: '通过快速测试来确保安全条件',
            para: [
                '汽车会从各种部件中释放挥发性有机化合物 (VOC)，并作为燃烧的副产品。这些挥发性有机化合物可能对人体健康和环境有害。一些被归类为人类致癌物（例如苯）。其他人则是造成烟雾和其他环境危害的因素。检测这些排放物并确定其来源有助于减少公众和环境暴露。因此，需要能够提供快速和全面分析并产生易于理解和有用的结果的可访问技术。',
                'NovaTest P100 和 P300 可以快速采样和分析任何位置的环境空气，使其成为排放测试的有用设备。该设备从环境空气中取样，无需任何额外的设备或样品制备。紧凑的设计使他们能够方便地测试传统台式设备无法进入的较小空间中的空气。它们能够在一次测试中以高灵敏度检测各种化合物，并且系统会自动生成带有计算结果的即时报告。这些功能可以轻松地用于生产线、停车场或检查车间，以快速评估车辆的排放。',
                'DV3000根据风向提供实时结果的驾驶测试和测绘。用户可以在路上进行监控，第一时间识别排放源。'
            ]
        }
    ],
    challenges: {
    ...
    description: [
        {
            title: '通过持续监控将风险降至最低',
            para: [
                '许多行业在其流程中使用会释放挥发性有机化合物 (VOC) 的组件。 VOC 数量众多、种类繁多且无处不在，包括人造和天然存在的化合物。 VOC 的来源包括油漆、清洁产品、溶剂、制冷剂、气体和燃料等。有些挥发性有机化合物对人体健康有害，对环境有害，有些则受法律管制。',
                '现场监测空气并立即产生结果，可以在小浓度 VOC 成为更大问题之前检测到它们的存在。围栏监测可以确保遵守排放法规，有助于保护周围社区。',
                'NovaTest A1000 提供连续在线监测解决方案，使其成为围栏监测的有用设备。 A1000 可以自动运行样品和分析环境空气，并在目标化合物超过特定阈值时提醒用户。持续的实时分析可提供即时反馈，从而能够及时有效地执行事件响应。'
            ]
        }
    ],
    challenges: {
    ...
    description: [
        {
            title: '石化行业解决方案',
            para: [
                '许多现代产品都含有源自原油中碳氢化合物的成分，使原油的提取和加工成为当今社会的重要行业。该行业还需要更好的新技术来有效应对处理挥发性有机化合物 (VOC) 的挑战。有些挥发性有机化合物对人体健康有害，对环境有害，有些则受法律管制。更好的检测和监控技术有助于保护石化设施、员工和环境。',
                'NovaTest P300 可以在任何位置快速测试环境空气，使其成为泄漏检测、勘探或其他 VOC 检测应用的有用设备。 P300 能够在一次测试中以高灵敏度检测多种化合物，并且系统会自动生成带有计算结果的即时报告。这些功能可用于有效识别泄漏和其他问题，以便尽快修复它们。 P300 还可用于探测在更深的深度生成后渗入地球表面的近地表碳氢化合物。近地表油气勘探与其他技术相结合，可以帮助集中目标区域进行进一步勘探，减少勘探时间、成本和风险。检测从地球表面逸出的 VOC 还使 P300 能够识别地下储罐泄漏造成的土壤污染。这种检测能力可用于监控加油站、工业场所和国防基地。',
                'NovaTest A1000 提供连续在线监测解决方案，使其成为职业健康和安全监测和围栏监测的有用设备。 A1000 可以自主采样和分析环境空气，并在目标化合物超过特定阈值时提醒用户。这可用于确保符合 OSHA 规定并保护员工的安全。由于能够远程操作，A1000 还可用于围栏监控，以确保符合 EPA 排放法规并保护周围社区的安全。连续、实时的分析可提供即时反馈，从而可以在检测到泄漏或其他问题时快速做出响应以最大程度地减少损失。'
            ]
        }
    ],
    challenges: {
    ...
    description: [
        {
            title: '了解空气质量',
            para: [
                '挥发性有机化合物 (VOC) 数量众多、种类繁多且无处不在，包括人造和天然存在的化合物。 VOC 的来源包括油漆、清洁产品、溶剂、制冷剂、气体和燃料等。有些挥发性有机化合物对人体健康有害，对环境有害，有些则受法律管制。',
                '现场监测空气并立即产生结果，可以在小浓度 VOC 成为更大问题之前检测到它们的存在。',
                'NovaTest P300 可以快速采样和分析任何位置的环境空气，使其成为空气质量测试的有用设备。',
                'P300 能够在一次测试中以高灵敏度检测多种化合物，并且系统会自动生成带有计算结果的即时报告。这些功能可用于有效识别空气质量问题，以便尽快解决。',
                'NovaTest A1000 提供空气监测站所需的连续在线监测解决方案。 A1000 可以自主采样和分析环境空气，并在目标化合物超过特定阈值时提醒用户。连续、实时的分析提供即时反馈，从而可以检查随时间变化的条件并确定污染源或事件。'
            ]
        },
        {
            title: 'BTEX',
...
export const LANDFILL_N_BIOGAS = {
    header: {
        ...
        head: '垃圾填埋场和沼气',
        text: '在任何位置对空气进行采样并查看即时结果的能力对于在污染源成为问题之前识别它们很重要。'
    },
    description: [
        {
            title: '有哪些污染源？',
            para: [
                '如果您认为挥发性有机化合物 (VOC) 仅存在于工业化学工厂中，那您就错了。 VOC 的来源多种多样，例如室内涂料、清洁产品、制冷剂、气体和燃料、汽车内饰材料分解、污染的地下水、电子制造、医药生产、食品和饮料生产、制造工厂等。空气监测可用于识别污染源，以防止对人类或环境健康造成损害。垃圾填埋场和沼气监测对于保护基础设施和公众非常重要。来自垃圾填埋场和沼气的 VOC 会导致负面的健康影响和腐蚀，以及严重的气味滋扰。',
                'NovaTest P100 和 P300 可以快速测试任何位置的环境空气，使其成为检测有害 VOC 的有用设备。它们能够在一次测试中以高灵敏度检测多种化合物，并且系统会自动生成带有计算结果的即时报告。这些功能可用于有效识别污染源，以便尽快修复。',
                'DV3000根据风向提供实时结果的驾驶测试和测绘。用户可以在路上进行监控，第一时间识别排放源。'
            ]
        }
    ],
...
export const VOCS_IN_WATER = {
    ...
    description: [
        {
            title: '了解水质',
            para: [
                '监测溶解在水中的化学物质也可以指示周围环境的其余部分的状况。因为挥发性有机化合物蒸发得如此之快，所以它们很容易从水中转移到空气中。水质与空气质量密切相关，监测两者对环境安全和保护至关重要。当更多的化学物质被引入环境中时，它们越来越有可能影响水质，从而影响健康质量。需要对水质问题做出快速反应，以确保社区的安全和保障。',
                '干净的水是必需品。对现场水进行监测并立即获得结果，可以在小浓度 VOC 成为更大问题之前检测到它们的存在。可以在饮用水分配点、废水处理设施、地下水修复项目或其他地点实施水监测，以确保可接受的水质。',
    ...
    challenges: {
        para: [
            '传统的水测试是间隔进行的，因此很难区分变化的条件。需要通过更快的分析进行持续测试，以提供有效响应所需的即时反馈',
            '综合分析往往需要使用多种技术进行多次测试，使测试变得复杂',
